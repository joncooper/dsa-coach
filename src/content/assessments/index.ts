...
import { inMemoryDbAssessment, inMemoryDbProblem } from "./inMemoryDb";
 ...
 */
const ASSESSMENT_PROBLEMS: Problem[] = [filesystemProblem, bankingProblem, inMemoryDbProblem];

export const assessments: Assessment[] = [
  filesystemAssessment,
  bankingAssessment,
  inMemoryDbAssessment
];
